...
**Задача 23:** Embedding Service (Local-First)
- Поддержка `bge-m3` (десктоп, 8+ ГБ RAM): гибридный поиск, отличный русский.
- Поддержка `nomic-embed-text` (VPS, 1-2 ГБ RAM): легковесная, 8k контекст.
- Чанкинг: 512-1024 токена, overlap 10-15%, привязка метаданных.
- Fallback на облако (OpenAI/Voyage AI).
